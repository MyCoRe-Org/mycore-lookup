 ...
 */
package org.mycore.lookup.common;
...
public class TextResolver {
 ...
 NoVariables
	...
	protected static class Variable extends Term {
		...
		/* (non-Javadoc)
		 * @see de.uni_jena.rz.services.common.TextResolver.Term#resolveInternal(java.lang.String, int)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see de.uni_jena.rz.services.common.TextResolver.Term#getStartEnclosingString()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see de.uni_jena.rz.services.common.TextResolver.Term#getEndEnclosingString()
		 */
		@Override
	...
	protected static class EscapeCharacter extends Term {
		...
		/* (non-Javadoc)
		 * @see de.uni_jena.rz.services.common.TextResolver.Term#resolve(java.lang.String, int)
		 */
		@Override
