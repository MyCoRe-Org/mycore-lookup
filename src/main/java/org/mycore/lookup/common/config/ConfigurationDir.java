 ...
 */
package org.mycore.lookup.common.config;
...
public class ConfigurationDir {
    ...
    private static String getConfigBaseName() {
        return isWindows() ? "MyCoRe" + File.separator + Application.APP_NAME
            : ".mycore" + File.separator + Application.APP_NAME.toLowerCase(Locale.ROOT);
    }
